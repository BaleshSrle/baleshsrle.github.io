(($) => {
    ...
    $(document).ready(() => {
        ...
        const MediaMarketUrl = "https://mediamarket.rs.ba/index.php/laptopi/koristeni-laptopi/";
        const BadgesUrl = ["https://img.shields.io/", "https://badgen.net/"];
        const WebOfTrustUrl = ["https://www.mywot.com/", "https://static.mywot.com/"];
        ...
        $("head").each((i, e) => {
            ...
            $(e).append($("<link>").attr({ rel: "dns-prefetch", "href": UrlCDN[0] }).on("error", function () { this.href = UrlCDN[1] }), $("<link>").attr({ rel: "preconnect", "href": UrlCDN[0], "crossorigin": "anonymous" }).on("error", function () { this.href = UrlCDN[1] }), $("<link>").attr({ rel: "icon", "href": "logo.png" })/*, $("<link>").attr({ rel: "stylesheet", "href": UrlCDN[0]+"npm/@fortawesome/fontawesome-free@6/css/all.min.css", "crossorigin": "anonymous" })*/, $("<link>").attr({ rel: "stylesheet", "href": UrlCDN[0] + "npm/flag-icons/css/flag-icons.min.css", "crossorigin": "anonymous" }).on("error", function () { this.href = UrlCDN[1] + "ajax/libs/flag-icons/7.5.0/css/flag-icons.min.css"; }),/* $("<script></script>").attr({ src: UrlCDN[0]+"npm/bootstrap@4/dist/js/bootstrap.bundle.min.js", "crossorigin": "anonymous" }),*/ $.getScript("https://kit.fontawesome.com/5aafa1a155.js"), $.getScript(WebOfTrustUrl[1]+"website_owners_badges/websiteOwnersBadge.js"));
        ...
        $("meta:last").after($("<link>").attr({ rel: "stylesheet", "href": UrlCDN[0] + "npm/bootstrap@4/dist/css/bootstrap.min.css", "crossorigin": "anonymous" }).on("error", function () { this.href = UrlCDN[1] + "ajax/libs/bootstrap/4.6.2/css/bootstrap.min.css" }));
        $("script[src*='jquery@3]").after($.getScript(UrlCDN[0]+"npm/jquery-migrate@4.0.2/dist/jquery-migrate.min.js"));
        $("script[src*='bootstrap@4]").on("error", function () { this.src = UrlCDN[1] + "ajax/libs/bootstrap/4.6.2/js/bootstrap.bundle.min.js"; });
        $("script[src*='countdown@2]").on("error", function () { this.src = UrlCDN[1] + "ajax/libs/jquery.countdown/2.2.0/jquery.countdown.min.js"; });
        ...
        $("#lenovoThinkPadX230_link").attr("href", MediaMarketUrl + "lenovothinkpadx230-434-detail");
        $("#fujitsuLifeBookS752_link").attr("href", MediaMarketUrl + "fsc-lifebook-s752-detail");
        $("#fujitsuLifeBookS761_link").attr("href", MediaMarketUrl + "fujitsulifebooks761-detail");
        ...
        $("footer > div:eq(0)").addClass("d-flex justify-content-center flex-wrap mx-auto").css("max-width", "292px").append($("<div></div>").addClass("mr-1").append($("<img>").attr({ src: BadgesUrl[0] + "github/v/release/twbs/bootstrap?filter=v4.*&logo=bootstrap&logoColor=white&label=Bootstrap&labelColor=7952b3&color=7952b3", alt: "Bootstrap", crossorigin: "anonymous" }).on("error", function () { this.src = BadgesUrl[1] + "jsdelivr/v/npm/bootstrap@4?color=7952b3&label=Bootstrap"; })), $("<div></div>").append($("<img>").attr({ src: BadgesUrl[0] + "github/v/release/jquery/jquery?filter=3.*&logo=jquery&logoColor=white&label=jQuery&labelColor=0769ad&color=0769ad", alt: "jQuery", crossorigin: "anonymous" }).on("error", function () { this.src = BadgesUrl[1] + "jsdelivr/v/npm/jquery@3?color=0769ad&label=jQuery" })), $("<div></div>").addClass("mr-1").append($("<img>").attr({ src: BadgesUrl[0] + "github/v/release/fortawesome/font-awesome?filter=7.*&logo=fontawesome&logoColor=white&logoSize=auto&label=Font%20Awesome&labelColor=538dd7&color=538dd7", alt: "Font Awesome", crossorigin: "anonymous" }).on("error", function () { this.src = BadgesUrl[1] + "npm/v/@fortawesome/fontawesome-free?color=538dd7&label=Font%20Awesome"; })), $("<div></div>").append($("<img>").attr({ src: BadgesUrl[0] + "website?url=https%3A%2F%2Fcdn.jsdelivr.net%2F&logo=jsdelivr&logoColor=white&label=jsDelivr%20CDN&labelColor=e84d3d&cacheSeconds=600", alt: "jsDelivr CDN", crossorigin: "anonymous" })));
